    ...
    <>
      ...
      >
        ...
        <ul className="relative flex flex-wrap gap-x-[23px] gap-y-[54px] max-w-[570px]">
          ...
          <div className="absolute top-[-7%] right-[-11%] w-[224px] h-[224px] sm:w-[203px] sm:h-[182px] sm:top-[-19%] sm:left-[91%] lg:w-[233px] lg:h-[233px] lg:top-[-40%] lg:left-[140%] xl:w-[292px] xl:h-[261px] xl:top-[-38%] xl:left-[158%]">
            <Image
              src={imgOne}
          ...
          <div className="hidden sm:block absolute top-[4%] left-[72%] w-[178px] h-[178px] sm:w-[198px] sm:h-[177px] sm:top-[-47%] sm:left-[68%] lg:w-[237px] lg:h-[237px] lg:top-[-14%] lg:left-[109%] xl:w-[350px] xl:h-[312px] xl:left-[104%]">
            <Image
              src={imgTwo}
          ...
          <div className="absolute top-[45%] right-[-12%] sm:top-[48%] sm:left-[97%] w-[213px] h-[190px] lg:w-[272px] lg:h-[243px] lg:top-[21%] lg:left-[135%] xl:w-[360px] xl:h-[322px] xl:top-[15%] xl:left-[156%]">
            <Image
              src={imgThree}
          ...
          <div className="absolute bottom-[68%] right-[3%] w-[135px] h-[121px] sm:w-[143px] sm:h-[129px] sm:bottom-[61%] sm:left-[101%] lg:w-[225px] lg:h-[202px] lg:bottom-[14%] lg:left-[105%] xl:left-[120%]">
            <Image
              src={imgFour}
          ...
          <div className="absolute bottom-[13%] right-[-6%] w-[221px] h-[198px] sm:hidden lg:block lg:w-[220px] lg:h-[198px] lg:left-[133%] lg:bottom-[-14%] xl:w-[346px] xl:h-[310px] xl:bottom-[-27%] xl:left-[149%]">
            <Image
              src={imgFive}
